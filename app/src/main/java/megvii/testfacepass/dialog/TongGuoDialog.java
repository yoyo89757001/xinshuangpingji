 ...
 * @author Tom.Cai
 */
public class TongGuoDialog extends Dialog {
    private Button a1;


    public TongGuoDialog(Context context) {
    ...
    private void setCustomDialog() {
        ...
        //获得当前窗体
        Window window = TongGuoDialog.this.getWindow();
        //重新设置
        WindowManager.LayoutParams lp = TongGuoDialog.this.getWindow().getAttributes();
